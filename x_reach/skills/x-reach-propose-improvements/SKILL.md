...
Turn external findings into clean candidate proposals for X Reach itself.
...
3. Draft only proposals that stay inside X Reach's thin-interface and caller-control policy.
4. For each proposal, include a suggested maintainer decision and the smallest safe patch boundary.
5. Hand the shortlist to [../x-reach-maintain-proposals/SKILL.md](../x-reach-maintain-proposals/SKILL.md) when the user wants formal adopt or reject judgment.
