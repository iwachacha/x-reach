...
Carry approved X Reach maintenance changes through implementation and shipping.
...
8. Commit, push, reinstall from the pushed exact commit or ref, rerun `x-reach skill --install`, and do a lightweight smoke check when requested or clearly warranted.
