...
def _request_scale_policy() -> dict[str, Any]:
    return {
        ...
        "rules": [
            ...
            "Concurrent broad runs should use explicit pacing such as `--query-delay 1 --throttle-cooldown 30`; repeated 409/429/conflict diagnostics should pause further fan-out.",
        ...
        "large_scale_research": {
            ...
            "steps": [
                ...
                "For explicit concurrency, add pacing such as `--concurrency 2 --query-delay 1 --throttle-cooldown 30` and inspect `throttle_sensitive_errors` before another pass.",
