    ...
    return {
        ...
        "large_scale_research": {
            ...
            "steps": [
                ...
                "Run `x-reach plan candidates --input .x-reach/evidence.jsonl --by normalized_url --limit 20 --max-per-author 2 --prefer-originals --drop-noise --json` for no-model dedupe.",
            ],
            "recommended_limits": {
                "discovery": 10,
