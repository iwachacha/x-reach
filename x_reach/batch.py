...
def _query_key(
    ...
    return (
        ...
        json.dumps(query.get("topic_fit"), ensure_ascii=False, sort_keys=True) if query.get("topic_fit") is not None else None,
