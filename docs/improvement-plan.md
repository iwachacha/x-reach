...
**狙い**
`cli` package と `mission.py` の変更容易性とレビュー性を上げる。

**やること**

* `x_reach/cli/` package を少なくとも以下に分割する。
...
[4]: https://github.com/iwachacha/x-reach/tree/main/x_reach/cli "x-reach/x_reach/cli at main · iwachacha/x-reach · GitHub"
